...
cc.math.OBB = function(aabb){
    this.center = cc.math.vec3((aabb.min.x + aabb.max.x)/2, (aabb.min.y + aabb.max.y)/2, (aabb.min.z + aabb.max.z)/2);   
    this.xAxis = cc.math.vec3(1, 0, 0);    
    this.yAxis = cc.math.vec3(0, 1, 0);    
    this.zAxis = cc.math.vec3(0, 0, 1);    
    this.extents = cc.math.vec3((aabb.max.x - aabb.min.x)/2, (aabb.max.y - aabb.min.y)/2, (aabb.max.z - aabb.min.z)/2);  
    this.extentX = cc.math.vec3((aabb.max.x - aabb.min.x)/2, 0, 0);  
    this.extentY = cc.math.vec3(0, (aabb.max.y - aabb.min.y)/2, 0);  
    this.extentZ = cc.math.vec3(0, 0, (aabb.max.z - aabb.min.z)/2);  
};
